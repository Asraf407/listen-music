...
const searchSong = () => {
    ...
    .catch(error=>displayError('Asraf found you in the position of something went wrong!! plz type another'));
}
...
.catch(error=>displayError("something went wrong!! plz try again"));
}
